...
<div class="container">
    ...
    <div>
        <h3 class="text-center" style="margin: 20px">Wines</h3>
        <br>
        <div class="d-flex flex-wrap justify-content-around align-items-start" style="gap: 24px;">
            <div class="card mb-4" style="width: 15rem; height: 400px;">
            ...
            <div class="card mb-4" style="width: 15rem; height: 400px;">
                ...
                <div class="card-body position-relative" style="overflow: hidden;">
                    ...
                    <p class="card-text">This wine smells light and fruity with hints of minerals, white flowers, and
                        peaches. It’s dry with a citrusy taste. It’s made in steel tanks without oak aging. Great with
                        seafood, chicken, and salads.</p>
                    <a href="#" class="btn btn-primary">Buy Now</a>
                    <div class="fade-effect"></div>
                </div>
            </div>
            ...
            <div class="card mb-4" style="width: 15rem; height: 400px;">
                ...
                <div class="card-body position-relative" style="overflow: hidden;">
                    ...
                    <p class="card-text">This wine has a strong smell of ripe black currants mixed with cedar, cloves,
                        and violets. It tastes round and full, like baked plums, and it has a good balance of chewy
                        tannins and not too much acidity.</p>
                    <a href="#" class="btn btn-primary">Buy Now</a>
                    <div class="fade-effect"></div>
                </div>
            </div>
            ...
            <div class="card mb-4" style="width: 15rem; height: 400px;">
                ...
                <div class="card-body position-relative" style="overflow: hidden;">
                    ...
                    <p class="card-text">Torres Mas la Plana is a deep, dense cherry colour, with a touch of mahogany.
                        It has a wonderfully intense bouquet typical of this vineyard with hints of blackberries,
                        cherries, truffles, spices such as clove, liquorice, black and white pepper. There is an
                        incense-like quality developed during ageing in wood. Full, elegant and pronounced aftertaste,
                        befitting a wine of this quality.</p>
                    <a href="#" class="btn btn-primary">Buy Now</a>
                    <div class="fade-effect"></div>
                </div>
            </div>
    ...
    <div>
        <h3 class="text-center" style="margin: 20px">Vodka</h3>
        <br>
        <div class="row">
...
<div>
    <h3 class="text-center" style="margin: 20px">Whiskey</h3>
    <br>
    <div class="row">
        <div class="col-md-3 mb-4">
            <div class="card" style="width: 15rem; margin: auto; height: 400px;">
...
<div>
    <h3 class="text-center" style="margin: 20px">Taquila</h3>
    <br>
    <div class="row">
        <div class="col-md-3 mb-4">
            <div class="card" style="width: 15rem; margin: auto; height: 400px;">
